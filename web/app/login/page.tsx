          ...
          >
            ...
            <div className="flex items-center justify-between w-full">
              <div className="flex gap-[10px] items-center justify-center">
                ...
                <label className="font-['Montserrat',sans-serif] font-normal text-[#484848] text-[12px] cursor-pointer">
                  Remember Me
                </label>
              </div>
              <a
                href="#"
                className="font-['Montserrat',sans-serif] font-normal text-[#135bec] text-[12px] hover:underline"
              >
                Forgot Password?
              </a>
            </div>
            ...
            <div className="flex flex-col gap-[30px] items-start w-full mt-2">
              ...
              <div className="flex gap-[10px] items-center w-full">
                ...
                <span className="font-['Montserrat',sans-serif] font-normal text-[#707070] text-[14px]">
                  Or Continue With
                </span>
                <div className="bg-[#dedede] flex-1 h-px" />
              </div>
              ...
              <div className="flex gap-[10px] items-start justify-center w-full">
                <button
                  type="button"
                  className="flex-1 rounded-[12px] border border-[#cecece] bg-white hover:bg-gray-50 transition-colors flex items-center justify-center py-[8px] px-[16px] gap-[8px]"
                >
                  <div className="relative size-[23px]">
                    ...
                    >
                      <path
                        d="M21.5625 13.6562C21.5625 8.625 19.0469 5.03125 15.8125 5.03125C13.2969 5.03125 11.5 7.90625 11.5 7.90625C10.0625 10.0625 10.0625 14.0156 12.2188 9.70312C12.2188 9.70312 14.0156 6.82812 15.8125 6.82812C18.3281 6.82812 19.6537 11.1406 19.6537 13.6562C19.6537 14.375 19.4062 15.8125 17.9688 15.8125V17.9688C19.4062 17.9688 21.5625 16.8906 21.5625 13.6562Z"
                        fill="url(#paint0_radial_26_344)"
                      />
                      <path
                        d="M7.1875 5.03125V7.1875C4.8875 7.475 3.59375 11.1406 3.59375 13.6562C3.59375 14.375 3.95313 15.8125 5.03125 15.8125C6.82813 15.8125 8.89434 11.845 10.7813 8.94311C11.7829 7.40262 12.78 8.72533 12.0197 10.0625C10.2183 13.2308 8.41442 17.9688 5.03125 17.9688C3.59375 17.9688 1.4375 16.8906 1.4375 13.6562C1.4375 7.1875 5.39063 5.03125 7.1875 5.03125Z"
                        fill="url(#paint1_radial_26_344)"
                      />
                      <path
                        d="M17.9688 15.8125C15.4531 15.8125 12.5781 5.03125 7.1875 5.03125V7.1875C11.5 7.1875 13.2969 17.9688 17.9688 17.9688V15.8125Z"
                        fill="#0768E1"
                      />
                      <defs>
                        <radialGradient
                          id="paint0_radial_26_344"
                          cx="0"
                          cy="0"
                          r="1"
                          gradientUnits="userSpaceOnUse"
                          gradientTransform="translate(17.9687 17.25) rotate(-101.31) scale(12.8272 9.97673)"
                        >
                          <stop stop-color="#0768E1" />
                          <stop offset="1" stop-color="#0082FB" />
                        </radialGradient>
                        <radialGradient
                          id="paint1_radial_26_344"
                          cx="0"
                          cy="0"
                          r="1"
                          gradientUnits="userSpaceOnUse"
                          gradientTransform="translate(7.1875 6.46875) rotate(154.537) scale(8.35885 4.38415)"
                        >
                          <stop stop-color="#0768E1" />
                          <stop offset="1" stop-color="#0082FB" />
                        </radialGradient>
                  ...
                  <span className="font-medium text-[#5f5f5f] text-[15px]">
                    Meta
                  </span>
                </button>
                <button
