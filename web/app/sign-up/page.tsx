            ...
            <div className="bg-[#f9fafb] flex-[1_1_50%] min-h-screen flex flex-col items-center justify-center relative p-8 py-12">
                <div className="flex flex-col gap-[40px] items-start w-full max-w-[465px]">
                    ...
                    <form className="flex flex-col gap-[20px] items-start w-full" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="flex flex-col gap-[10px] items-start w-full">
                            <label className="font-['Montserrat',sans-serif] font-normal text-[#151515] text-[12px]">Business Name</label>
                            <div className="bg-white h-[44px] relative rounded-[12px] w-full border border-[#e5e7eb] focus-within:border-[#135bec] transition-colors">
                                <input
                                    type="text"
                        ...
                        <div className="flex items-center w-full">
                            <div className="flex gap-[10px] items-center justify-start">
                                <div className="bg-white relative rounded-[7px] size-[20px] border border-[#e5e7eb] flex items-center justify-center cursor-pointer shrink-0">
                                ...
                                <label className="font-['Montserrat',sans-serif] font-normal text-[#484848] text-[12px] cursor-pointer">
                                    I agree to the <a href="#" className="font-medium text-[#135bec] hover:underline">Terms of Service</a> and <a href="#" className="font-medium text-[#135bec] hover:underline">Privacy Policy</a>
                                </label>
                            </div>
                        </div>
